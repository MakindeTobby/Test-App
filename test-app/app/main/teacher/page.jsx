'use client'
import { deleteTeacher, fetchTeacher } from '@/api';
        ...
        <div className="container flex justify-center items-center mt-5">
            ...
            <div className="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8  mx-auto">
                <div className="align-middle rounded-tl-lg rounded-tr-lg inline-block w-full py-4 overflow-hidden bg-white shadow-lg px-12">
                    <h1 className='text-center text-3xl font-bold'>Staff List</h1>
                </div>
                    ...
                    <table className="min-w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Teacher No.</th>
                                <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">D.O.B</th>
                                <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Salary</th>
                        ...
                        <tbody className="bg-white">
                            {
                                teachers.map(data =>
                                    ...
                                    <tr key={data.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                            <div className="text-sm leading-5 text-blue-900">{data.title}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                        ...
                                        <td className="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{data.teacherNumber}</td>

                                        <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{data.dateOfBirth}</td>
                                        <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{data.salary}</td>
